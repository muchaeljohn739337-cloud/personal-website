  ...
  const fetchDashboardData = async () => {
    try {
      ...
      setData({
        ...
        transactionVolume: dashboardData.transactionVolume || 0,
        activeUsers: dashboardData.activeUsers || 0,
        growthRate: dashboardData.growthRate || 0,
        pendingPayouts: dashboardData.pendingPayouts || 0,
        fraudBlocked: dashboardData.fraudBlocked || 0,
              ...
              <>
                ...
                {data.growthRate > 0 ? (
                  <div className="flex items-center gap-1 text-sm">
                    ...
                    <span className="text-violet-400">+{data.growthRate.toFixed(1)}%</span>
                    <span className="text-slate-400">vs last month</span>
                  </div>
                ) : (
                  <div className="text-sm text-slate-400">New account - Start earning today!</div>
                )}
              </>
            )}
          </div>
